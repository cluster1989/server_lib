...
type TestConfig struct {
	ID     int            `soulte:"core:id"`
	Col    string         `soulte:"core:col"`
	Ignore int            `soulte:"-"`
	Arr    []string       `soulte:"core:arr:,"`
	Arr1   []int          `soulte:"core:arr1:,"`
	Test   time.Duration  `soulte:"core:t_1:time"`
	Buf    int            `soulte:"core:buf:memory"`
	M      map[int]string `soulte:"core:map:,"`
}
