...
func NewFileWriter() logs2.Logger2 {
	w := &FileLogWriter{
		Daily:      true,
		MaxDays:    7,
		Rotate:     true,
...
//  	"perm":"0600"
//	}
func (w *FileLogWriter) Init(jsonConfig interface{}) error {

	conf := jsonConfig.(*FileLogWriter)
...
// func init() {
// 	logs2.DefaultLogger().Register("file", nil, NewFileWriter)
// }
